                  ...
                  <template 
                    ...
                    >
                      <tr name="oddsTr" style="text-align:center" cid="3" :class="index % 2 !== 0 ? 'tb-bgcolor1' : 'tb-bgcolor1'">
                        <td v-show="showColumn.first" width="6%"><span class="" :class="getClassOddChange(item?.overUnder, 1, 1)">{{ getOddNumberToNegative(item?.overUnder?.first?.[1]) }}</span></td>
                        <td v-show="showColumn.first" width="6%"><span class="" :class="getClassOddChange(item?.overUnder, 0, 1)">{{ getOddNumber(item?.overUnder?.first?.[0]) }}</span></td>
                        <td v-show="showColumn.first" width="6%" class="rb "><span :class="getClassOddChange(item?.overUnder, 2, 1)">{{ getOddNumberToNegative(item?.overUnder?.first?.[2]) }}</span></td>
                        <td v-show="showColumn.second" width="6%"><span class="" :class="getOddChange(item?.overUnder?.live?.[1], item?.overUnder?.first?.[1])">{{ getOddNumberToNegative(item?.overUnder?.live?.[1]) }}</span></td>
                        <td v-show="showColumn.second" width="6%"><span class="" :class="getOddChange(item?.overUnder?.live?.[0], item?.overUnder?.first?.[0])">{{ getOddNumber(item?.overUnder?.live?.[0]) }}</span></td>
                        <td v-show="showColumn.second" width="6%" class="rb "><span :class="getOddChange(item?.overUnder?.live?.[2], item?.overUnder?.first?.[2])">{{ getOddNumberToNegative(item?.overUnder?.live?.[2]) }}</span></td>
                        <td v-show="showColumn.third" width="6%"><span class="" :class="getClassOddChange(item?.overUnder, 1)">{{ getOddNumberToNegative(item?.overUnder?.run?.[1]) }}</span></td>
                        <td v-show="showColumn.third" width="6%"><span class="" :class="getClassOddChange(item?.overUnder, 0)">{{ getOddNumber(item?.overUnder?.run?.[0]) }}</span></td>
                        <td v-show="showColumn.third" width="6%" class="rb "><span :class="getClassOddChange(item?.overUnder, 2)">{{ getOddNumberToNegative(item?.overUnder?.run?.[2]) }}</span></td>
