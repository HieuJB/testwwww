<template>
  ...
  <div class="mcontent">
    <div id="main" class="container row">
      ...
      <!--left end -->
      <!--min start -->
      <LivescoreComponent :h1="h1Content" v-model:favoritesInit="favorites" :page="LIVESCORE_PAGE.FAVORITES" :content="pageContent" :favorites="favorites"/>
      <!--min end -->
