...
const sitemapLeagues_xml = defineEventHandler(async (event) => {
  var _a, _b, _c, _d;
  const sitemapObject = [];
  try {
    ...
    if (dashboardData == null ? void 0 : dashboardData.leagues) {
      (_d = (_c = dashboardData == null ? void 0 : dashboardData.leagues) == null ? void 0 : _c.pages) == null ? void 0 : _d.map((item) => {
        sitemapObject.push([
          "<sitemap>",
          `<loc>${scheme}${host}/sitemap/sitemap_league-${item == null ? void 0 : item.page}.xml</loc>`,
...
export { sitemapLeagues_xml as default };
//# sourceMappingURL=sitemap-leagues.xml.mjs.map
