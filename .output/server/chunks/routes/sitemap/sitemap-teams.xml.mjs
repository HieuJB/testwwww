...
const sitemapTeams_xml = defineEventHandler(async (event) => {
  ...
  try {
    ...
    if (dashboardData == null ? void 0 : dashboardData.teams) {
      (_d = (_c = dashboardData == null ? void 0 : dashboardData.teams) == null ? void 0 : _c.pages) == null ? void 0 : _d.map((item) => {
        sitemapObject.push([
          "<sitemap>",
          `<loc>${scheme}${host}/sitemap/sitemap_team-${item == null ? void 0 : item.page}.xml</loc>`,
