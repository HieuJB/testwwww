...
const sitemapCategories_xml = defineEventHandler(async (event) => {
  var _a, _b, _c, _d;
  const sitemapObject = [];
  try {
    ...
    if (dashboardData == null ? void 0 : dashboardData.categories) {
      (_d = (_c = dashboardData == null ? void 0 : dashboardData.categories) == null ? void 0 : _c.pages) == null ? void 0 : _d.map((item) => {
        sitemapObject.push([
          "<sitemap>",
          `<loc>${scheme}${host}/sitemap/sitemap_category-${item == null ? void 0 : item.page}.xml</loc>`,
...
export { sitemapCategories_xml as default };
//# sourceMappingURL=sitemap-categories.xml.mjs.map
