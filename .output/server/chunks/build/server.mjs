import { hasInjectionContext, inject, toRef, version, ref, watchEffect, watch, getCurrentInstance, isRef, defineComponent, provide, createElementBlock, h, onUnmounted, computed, unref, shallowReactive, Suspense, nextTick, Transition, useSSRContext, resolveComponent, Fragment, mergeProps, withCtx, createTextVNode, createVNode, toDisplayString as toDisplayString$1, createApp, effectScope, reactive, isReactive, toRaw, shallowRef, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, getCurrentScope, onScopeDispose, isReadonly, toRefs, markRaw, toValue, Text, isShallow, createSlots, renderList, renderSlot } from 'vue';
import { $ as $fetch, p as createError$1, Q as klona, R as parse$1, S as getRequestHeader, D as defu, T as sanitizeStatusCode, w as destr, U as isEqual$1, V as setCookie, W as getCookie, X as deleteCookie, Y as createHooks, A as toRouteMatcher, B as createRouter$1, Z as getRequestHeaders } from '../runtime.mjs';
...
import { ssrRenderComponent, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode, ssrRenderSlot } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const __nuxt_page_meta$6 = {
  validate: async (route) => {
    var _a;
    const authorSlug = (_a = route.params.author) == null ? void 0 : _a.match(/[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/);
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CX-FfrjW.mjs').then((m) => m.default || m)
  },
  {
    name: "/warehouse___en",
    path: "/en/warehouse",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-CHLa-7YE.mjs').then((m) => m.default || m)
  },
  {
    name: "/match___en",
    path: "/en/match/:id",
  ...
  {
    name: "/double-chance-odds___vi",
    path: "/double-chance-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-ChAASbBf.mjs').then((m) => m.default || m)
  },
  {
    name: "/double-chance-odds___en",
    path: "/en/double-chance-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-ChAASbBf.mjs').then((m) => m.default || m)
  ...
  {
    name: "/correct-score-odds___vi",
    path: "/correct-score-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-BDpnHR3K.mjs').then((m) => m.default || m)
  },
  {
    name: "/correct-score-odds___en",
    path: "/en/correct-score-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-BDpnHR3K.mjs').then((m) => m.default || m)
  ...
  {
    name: "/euro-handicap-odds___vi",
    path: "/euro-handicap-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-DUS0qPUp.mjs').then((m) => m.default || m)
  },
  {
    name: "/euro-handicap-odds___en",
    path: "/en/euro-handicap-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-DUS0qPUp.mjs').then((m) => m.default || m)
  ...
  {
    name: "/corner-ou-odds___vi",
    path: "/corner-ou-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-BbXRf1T_.mjs').then((m) => m.default || m)
  },
  {
    name: "/corner-ou-odds___en",
    path: "/en/corner-ou-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-BbXRf1T_.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-DgBn2GK_.mjs').then((m) => m.default || m)
  },
  {
    name: "/1x2-odds___en",
    path: "/en/1x2-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-DgBn2GK_.mjs').then((m) => m.default || m)
  ...
  {
    name: "/over-under-odds___vi",
    path: "/over-under-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-C98MNxp6.mjs').then((m) => m.default || m)
  },
  {
    name: "/over-under-odds___en",
    path: "/en/over-under-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-C98MNxp6.mjs').then((m) => m.default || m)
  ...
  {
    name: "/oddshistory___vi",
    path: "/oddshistory/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-Ce2OMx1S.mjs').then((m) => m.default || m)
  },
  {
    name: "/oddshistory___en",
    path: "/en/oddshistory/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-Ce2OMx1S.mjs').then((m) => m.default || m)
  ...
  {
    name: "/asian-handicap-odds___vi",
    path: "/asian-handicap-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-aorvxJwD.mjs').then((m) => m.default || m)
  },
  {
    name: "/asian-handicap-odds___en",
    path: "/en/asian-handicap-odds/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-aorvxJwD.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-Bi2yLpen.mjs').then((m) => m.default || m)
  },
  {
    name: "/oddscomp___en",
    path: "/en/oddscomp/:match_id",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-Bi2yLpen.mjs').then((m) => m.default || m)
  ...
  {
    name: "/detail-news___vi",
    path: "/:news",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_news_-CaV_tR7U.mjs').then((m) => m.default || m)
  },
  {
    name: "/detail-news___en",
    path: "/en/:news",
    meta: {},
    alias: [],
    redirect: void 0 ,
  ...
  {
    name: "/category_4___vi",
    path: "/tin-nong",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_category_-yMzqwd7n.mjs').then((m) => m.default || m)
  },
  {
    name: "/category_4___en",
    path: "/en/tin-nong",
    meta: {},
    alias: [],
    redirect: void 0 ,
  ...
  {
    name: "/category_1___en",
    path: "/en/tin-the-thao",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_category_-yMzqwd7n.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-B18Akx_7.mjs').then((m) => m.default || m)
  },
  {
    name: "/news___en",
    path: "/en/tin-tuc",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_tag_-BTjj7jge.mjs').then((m) => m.default || m)
  },
  {
    name: "/tag___en",
    path: "/en/tag/:tag",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-B9lTDdin.mjs').then((m) => m.default || m)
  },
  {
    name: "coach-id___en",
    path: "/en/coach/:id()",
  ...
  {
    name: "favourites___vi",
    path: "/bong-da/theo-doi",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-C6m6I2ES.mjs').then((m) => m.default || m)
  },
  {
  ...
  {
    name: "favourites-leagues___vi",
    path: "/bong-da/theo-doi/giai-dau",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./leagues-BHGOj0_B.mjs').then((m) => m.default || m)
  },
  {
    name: "favourites-leagues___en",
    path: "/en/favourites/leagues",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./leagues-BHGOj0_B.mjs').then((m) => m.default || m)
  ...
  {
    name: "favourites-teams___vi",
    path: "/bong-da/theo-doi/doi",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./teams-vMNo9518.mjs').then((m) => m.default || m)
  },
  {
    name: "favourites-teams___en",
    path: "/en/favourites/leagues",
    meta: {},
    alias: [],
    redirect: void 0 ,
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-GenH8CzM.mjs').then((m) => m.default || m)
  },
  {
    name: "iframe___en",
    path: "/en/iframe",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index--e1_9poK.mjs').then((m) => m.default || m)
  },
  {
    name: "index___en",
    path: "/en",
  ...
  {
    name: "league-league_id___vi",
    path: "/league/:league_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_league_id_-CM6jdw_n.mjs').then((m) => m.default || m)
  },
  {
    name: "league-league_id___en",
    path: "/en/league/:league_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_league_id_-CM6jdw_n.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-35TAPIgn.mjs').then((m) => m.default || m)
  },
  {
    name: "league___en",
    path: "/en/league",
  ...
  {
    name: "league-schedule-league_id___vi",
    path: "/league/schedule-:league_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./schedule-_league_id_-BR58dBG5.mjs').then((m) => m.default || m)
  },
  {
    name: "league-schedule-league_id___en",
    path: "/en/league/schedule-:league_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./schedule-_league_id_-BR58dBG5.mjs').then((m) => m.default || m)
  ...
  {
    name: "league-standings-league_id___vi",
    path: "/league/standings-:league_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./standings-_league_id_-LsRM1Nin.mjs').then((m) => m.default || m)
  },
  {
    name: "league-standings-league_id___en",
    path: "/en/league/standings-:league_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./standings-_league_id_-LsRM1Nin.mjs').then((m) => m.default || m)
  ...
  {
    name: "livescore-category___en",
    path: "/en/livescore/:category()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_category_-D6nSNlhX.mjs').then((m) => m.default || m)
  ...
  {
    name: "match-match_id___vi",
    path: "/match/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-B-CzY3G3.mjs').then((m) => m.default || m)
  },
  {
    name: "match-match_id___en",
    path: "/en/match/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-B-CzY3G3.mjs').then((m) => m.default || m)
  ...
  {
    name: "match-h2h-match_id___vi",
    path: "/match/h2h-:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./h2h-_match_id_-DnTE4_qf.mjs').then((m) => m.default || m)
  },
  {
    name: "match-h2h-match_id___en",
    path: "/en/match/h2h-:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./h2h-_match_id_-DnTE4_qf.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-sEHR2BCg.mjs').then((m) => m.default || m)
  },
  {
    name: "match___en",
    path: "/en/match",
  ...
  {
    name: "match-player-statistics___vi",
    path: "/match/player-statistics",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./player-statistics-BPdKMXL2.mjs').then((m) => m.default || m)
  },
  {
    name: "match-player-statistics___en",
    path: "/en/match/player-statistics",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./player-statistics-BPdKMXL2.mjs').then((m) => m.default || m)
  ...
  {
    name: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.name) ?? "news-author-author___vi",
    path: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.path) ?? "/news/author/:author()",
    meta: __nuxt_page_meta$6 || {},
    alias: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.alias) || [],
    redirect: __nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.redirect,
    component: () => import('./_author_-MWktEnO0.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.name) ?? "news-author-author___en",
    path: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.path) ?? "/en/news/author/:author()",
    meta: __nuxt_page_meta$6 || {},
    alias: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.alias) || [],
    redirect: __nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.redirect,
    component: () => import('./_author_-MWktEnO0.mjs').then((m) => m.default || m)
  ...
  {
    name: "news-category-category___vi",
    path: "/danh-muc/\\:category",
    meta: {},
    alias: [],
    redirect: void 0 ,
  ...
  {
    name: "news-tags-tag___en",
    path: "/en/news/tags/:tag()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_tag_-BTjj7jge.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-1x2-odds-match_id___vi",
    path: "/odds/1x2-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-DgBn2GK_.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-1x2-odds-match_id___en",
    path: "/en/odds/1x2-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-DgBn2GK_.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-asian-handicap-odds-match_id___vi",
    path: "/odds/asian-handicap-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-aorvxJwD.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-asian-handicap-odds-match_id___en",
    path: "/en/odds/asian-handicap-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-aorvxJwD.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-corner-ou-odds-match_id___vi",
    path: "/odds/corner-ou-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-BbXRf1T_.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-corner-ou-odds-match_id___en",
    path: "/en/odds/corner-ou-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-BbXRf1T_.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-correct-score-odds-match_id___vi",
    path: "/odds/correct-score-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-BDpnHR3K.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-correct-score-odds-match_id___en",
    path: "/en/odds/correct-score-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-BDpnHR3K.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-double-chance-odds-match_id___vi",
    path: "/odds/double-chance-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-ChAASbBf.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-double-chance-odds-match_id___en",
    path: "/en/odds/double-chance-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-ChAASbBf.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-euro-handicap-odds-match_id___vi",
    path: "/odds/euro-handicap-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-DUS0qPUp.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-euro-handicap-odds-match_id___en",
    path: "/en/odds/euro-handicap-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-DUS0qPUp.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-oddscomp-match_id___vi",
    path: "/odds/oddscomp/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-Bi2yLpen.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-oddscomp-match_id___en",
    path: "/en/odds/oddscomp/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-Bi2yLpen.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-oddshistory-match_id___vi",
    path: "/odds/oddshistory/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-Ce2OMx1S.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-oddshistory-match_id___en",
    path: "/en/odds/oddshistory/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-Ce2OMx1S.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-over-under-odds-match_id___vi",
    path: "/odds/over-under-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-C98MNxp6.mjs').then((m) => m.default || m)
  ...
  {
    name: "odds-over-under-odds-match_id___en",
    path: "/en/odds/over-under-odds/:match_id()",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_match_id_-C98MNxp6.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-qxNlOlcU.mjs').then((m) => m.default || m)
  },
  {
    name: "player-id___en",
    path: "/en/player/:id()",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-Bo_1CAao.mjs').then((m) => m.default || m)
  },
  {
    name: "player___en",
    path: "/en/player",
  ...
  {
    name: "results___vi",
    path: "/bong-da/ket-qua-bong-da",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-D__YqYEf.mjs').then((m) => m.default || m)
  },
  {
    name: "results___en",
    path: "/en/football/results",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-D__YqYEf.mjs').then((m) => m.default || m)
  ...
  {
    name: "schedule___vi",
    path: "/bong-da/lich-thi-dau",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BEb98c9s.mjs').then((m) => m.default || m)
  },
  {
    name: "schedule___en",
    path: "/en/football/schedule",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BEb98c9s.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-ZFrciVrl.mjs').then((m) => m.default || m)
  },
  {
    name: "team-id___en",
    path: "/en/team/:id()",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-DZTaMHO3.mjs').then((m) => m.default || m)
  },
  {
    name: "team___en",
    path: "/en/team",
...
const defaultsWaitI18n_fcc0iSNKKy = /* @__PURE__ */ defineNuxtPlugin({
  ...
  setup(nuxtApp) {
    var _a, _b;
    const siteConfig = useSiteConfig();
    const locale = ref(((_b = (_a = nuxtApp.$i18n) == null ? void 0 : _a.locale) == null ? void 0 : _b.value) || siteConfig.currentLocale || siteConfig.defaultLocale);
...
const layouts = {
  default: () => import('./default-DW_eXSdq.mjs').then((m) => m.default || m),
  error: () => import('./error-DkunaUKT.mjs').then((m) => m.default || m)
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="prose mt-5"${_scopeId}><div class="min-h-screen flex flex-grow items-center justify-center bg-gray-50"${_scopeId}><div class="rounded-lg p-8 text-center shadow-xl"${_scopeId}><h1 class="mb-4 text-4xl font-bold"${_scopeId}>${ssrInterpolate(__props.error.statusCode)}</h1><p class="text-gray-600 mb-5"${_scopeId}>${ssrInterpolate(__props.error.statusMessage ? __props.error.statusMessage : "Oops! Có lỗi xẩy ra.")}</p>`);
            _push2(ssrRenderComponent(_component_nuxt_link, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Trờ về Trang chủ `);
                } else {
                  return [
                    createTextVNode(" Trờ về Trang chủ ")
                  ];
                }
              }),
              _: 1
              ...
              createVNode("div", { class: "prose mt-5" }, [
                createVNode("div", { class: "min-h-screen flex flex-grow items-center justify-center bg-gray-50" }, [
                  createVNode("div", { class: "rounded-lg p-8 text-center shadow-xl" }, [
                    createVNode("h1", { class: "mb-4 text-4xl font-bold" }, toDisplayString$1(__props.error.statusCode), 1),
                    createVNode("p", { class: "text-gray-600 mb-5" }, toDisplayString$1(__props.error.statusMessage ? __props.error.statusMessage : "Oops! Có lỗi xẩy ra."), 1),
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-BtlR6lWt.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { useOgImageRuntimeConfig as A, useSiteConfig as B, _export_sfc as _, useState as a, useCookie as b, createError as c, useHead as d, entry$1 as default, useRouter as e, __nuxt_component_0$2 as f, useRuntimeConfig as g, asyncDataDefaults as h, useNuxtApp as i, fetchDefaults as j, useRequestFetch as k, defineStore as l, useRequestEvent as m, navigateTo as n, hasProtocol as o, joinURL as p, parseURL as q, encodeParam as r, stringifyQuery as s, encodePath as t, useRoute as u, showError as v, withLeadingSlash as w, useLocalePath as x, __nuxt_component_2$1 as y, useError as z };
