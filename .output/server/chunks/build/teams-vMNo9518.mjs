  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_LivescoreComponent, {
        ...
        favorites: ("FAVORITES_TYPE" in _ctx ? _ctx.FAVORITES_TYPE : unref(FAVORITES_TYPE)).TEAMS
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/favourites/teams.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=teams-vMNo9518.mjs.map
