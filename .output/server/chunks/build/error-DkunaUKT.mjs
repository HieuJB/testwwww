import { e as useRouter, u as useRoute, b as useCookie, d as useHead, f as __nuxt_component_0$2 } from './server.mjs';
...
import { a as ROUTERS_GROUP, R as ROUTERS, A as API_ROUTERS } from './routers-Dr-sal51.mjs';
...
import { i as LIVESCORE_ACTIVE_TAB } from './constants-DJp0NbxW.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        class: ["sub1_2 nav__list", ((_a2 = routerUrl.value) == null ? void 0 : _a2.includes(("ROUTERS" in _ctx ? _ctx.ROUTERS : unref(ROUTERS)).LEAGUES)) ? "on" : ""]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Kho d\u1EEF li\u1EC7u `);
...
//# sourceMappingURL=error-DkunaUKT.mjs.map
