...
import { h as LIVESCORE_PAGE, F as FAVORITES_TYPE } from './constants-DJp0NbxW.mjs';
  ...
  async setup(__props) {
    ...
    const fetchPage = async (slug) => {
      try {
        ...
        }), "$xy8131UMRx").then((resData) => {
          var _a2, _b2;
          var _a, _b, _c, _d, _e, _f, _g, _h;
          title.value = (_a2 = (_b = (_a = resData == null ? void 0 : resData.data) == null ? void 0 : _a.value) == null ? void 0 : _b.title) != null ? _a2 : getConfig(storeSystems.configurations, "SEO_META_TITLE"), description.value = (_b2 = (_d = (_c = resData == null ? void 0 : resData.data) == null ? void 0 : _c.value) == null ? void 0 : _d.meta_description) != null ? _b2 : getConfig(storeSystems.configurations, "SEO_META_DESCRIPTION");
    ...
    [__temp, __restore] = withAsyncContext(() => fetchPage("bong-da-theo-doi")), await __temp, __restore();
    nextTick(async () => {
      useHead({
        title: title.value,
        meta: [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_LivescoreComponent, {
        ...
        favorites: ("FAVORITES_TYPE" in _ctx ? _ctx.FAVORITES_TYPE : unref(FAVORITES_TYPE)).LEAGUES
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/favourites/leagues.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=leagues-BHGOj0_B.mjs.map
