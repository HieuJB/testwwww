...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props, { emit: __emit }) {
            ...
            if ((_a2 = wssItem.payload) == null ? void 0 : _a2.iodds) {
              ...
              if (matchOdds == null ? void 0 : matchOdds[handicap]) {
                for (const matchOdd of matchOdds == null ? void 0 : matchOdds[handicap]) {
                  ...
                  if (matchId == ((_d = (_c = matchLiveDetail.value) == null ? void 0 : _c.match) == null ? void 0 : _d.i_match_id)) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="rankbox"><table class="eTable adaptMt" id="etable-header" width="25%" cellspacing="0" cellpadding="0" style="${ssrRenderStyle({ "float": "left", "min-width": "135px" })}"><tbody><tr class="tr-title"><th colspan="2" rowspan="2"><b>C\xF4ng ty</b><img alt="plus"${ssrRenderAttr("src", _imports_0)}></th><th></th></tr><tr class="tb-bgcolor1"><th></th></tr><!--[-->`);
      ...
      _push(`<!--]--></tbody></table><div class="rankdata w-100"><table class="eTable adaptMt w-100" cellspacing="0" cellpadding="0" width="100%"><tbody><tr class="tr-title"><th colspan="3" style="${ssrRenderStyle(!unref(isMobile) ? null : { display: "none" })}"><b>S\u1EDBm</b></th><th colspan="3" style="${ssrRenderStyle(!unref(isMobile) ? null : { display: "none" })}"><b>Live</b></th><th colspan="3" style="${ssrRenderStyle(!unref(isMobile) ? null : { display: "none" })}"><b>Run Odds</b></th><th rowspan="2" style="${ssrRenderStyle(!unref(isMobile) ? null : { display: "none" })}"><b>Chi ti\u1EBFt</b></th></tr><tr class="tr-title"><th>Ch\u1EE7</th><th>HDP</th><th>Kh\xE1ch</th><th style="${ssrRenderStyle(!unref(isMobile) ? null : { display: "none" })}">Ch\u1EE7</th><th style="${ssrRenderStyle(!unref(isMobile) ? null : { display: "none" })}">HDP</th><th style="${ssrRenderStyle(!unref(isMobile) ? null : { display: "none" })}">Kh\xE1ch</th><th style="${ssrRenderStyle(!unref(isMobile) ? null : { display: "none" })}">Ch\u1EE7</th><th style="${ssrRenderStyle(!unref(isMobile) ? null : { display: "none" })}">HDP</th><th style="${ssrRenderStyle(!unref(isMobile) ? null : { display: "none" })}">Kh\xE1ch</th><th style="${ssrRenderStyle(unref(isMobile) ? null : { display: "none" })}">Chi ti\u1EBFt</th></tr><!--[-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/odds/asian-handicap-odds/[match_id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_match_id_-aorvxJwD.mjs.map
