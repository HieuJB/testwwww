...
const vueuseHead_a4365c50 = defineNuxtPlugin((nuxtApp) => {
...
const metaConfig = { "globalMeta": { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "name": "theme-color", "content": "#ffdd67" }], "title": "Nuxt3 PWA", "charset": "utf-8", "link": [{ "hid": "icon", "rel": "icon", "type": "image/png", "href": "/logo_x32.png" }, { "hid": "apple-touch-icon", "rel": "apple-touch-icon", "href": "/logo_x180.png" }, { "rel": "manifest", "href": "/manifest.json" }], "style": [], "script": [] }, "mixinKey": "created" };
const plugin_392d8c68 = defineNuxtPlugin((nuxtApp) => {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "center" }, _attrs))}><h1>Nuxt3 PWA</h1><img${serverRenderer.exports.ssrRenderAttr("src", "/pwa.jpg")} alt="Nuxt3 PWA"><p> This page can be displayed offline ! </p></div>`);
}
