				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						<div id="description">
							<h1>KML File</h1>
							  ...
							  <p>
								Learn more about <a href="https://developers.google.com/kml/documentation/" target="_blank">KML File</a>.
                </p>
						</div>
						<div id="content">
							<p class="expl">
					...
					<xsl:otherwise>
						<div id="description">
							<h1>XML Sitemap</h1>
							  <p>
									This XML Sitemap is generated by MK. It is what search engines like Google use to crawl and re-crawl posts/category/matches/leagues on your website.
                </p>
							  <p>
